...
| 真实权重全链路测试 | `9312bf5`，tests/test_activity_family_real_acceptance.py | 方案A代码和离线工程验收完成，全批双审通过，draft PR #29待授权合并。e409125的Linux CI run35443974454全7项成功；文档后续head以PR最新检查为准。证据见[交接](family-real-acceptance-integration.md)。真实目录和精确bundle另行配置授权，不把合成前向当真实模型验收。 |
