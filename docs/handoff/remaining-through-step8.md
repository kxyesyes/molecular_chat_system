...
| 3. Domain API routes | Domain-specific setup functions replace the mixed registrar; URL, HTTP/response contracts and shared service lifetimes verified | LOCAL COMPLETE, PR #64 CI FOLLOW-UP: all30 operations moved, independent SPEC/QUALITY approved, joint5965 passed/3 skipped/11 subtests; each of3 framework profiles68 passed. First CI root timed out; reviewed PR #65 workload partition integrated, post-integration85 passed; fresh8-check CI pending. See domain-api-separation.md |
