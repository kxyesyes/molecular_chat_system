...
| 3. Domain API routes | Domain-specific setup functions replace the mixed registrar; URL, HTTP/response contracts and shared service lifetimes verified | IN PROGRESS: 30-operation inventory; original nine-file baseline 169 passed, 1 skipped, 11 subtests; see domain-api-separation.md |
