...
| 7. Production-entry dynamic decisions | Normal Web entry actually supports the approved model-driven decision path, using existing loop/Session/authorization/evidence and bounded recovery; integration/browser evidence | PENDING overall. A1 #78 merged `782cd13129cb4c2328c398a3930f61172ea3ec62`; A2 #79 merged `ed284b7baed2024d10de80583d524c828683585a`, reviewed/merged tree equal and parent-reported CI8/8. Ordinary semantic chat Task1 strict intent protocol is locally committed as `be0b268` after independent SPEC/QUALITY and 312 focused tests; not published or wired. Task2 shared transport is locally committed as `162a4ac` after SPEC/QUALITY and 226 focused tests. Task3 capability/admission contracts are locally committed as `e295589` after a journal-consistency P2 fix, SPEC/QUALITY approval and 357 focused tests. Task4 whole-request assessment/preparation has independent SPEC/QUALITY approval and 611 focused tests (109 new + 502 existing), ready for local checkpoint; all remain unwired/unpublished. Tasks5–9, B bindings, C integration and final real ordinary-chat/multi-turn evidence remain pending; deployment excluded |
