...
PR75 integration: fixture correction was committed as `be46b70f6e670bf96583fc058c908572f4789b44`. After PR75's independent reviews and CI8/8, fetched main `7b5611fed039aa7aebde62063f45e45e965cf23a` was merged without conflicts as `666dbada4891f4eb37c1f424c07812363f9466a9`. Only upstream inventory test/document files changed; the seven ADMET code/test files remain byte-identical to `be46b70`. Existing isolated runner with `tests/agent/test_tool_contract_inventory.py tests/agent/test_analysis_contract.py` produced **565 passed in 4.50s**, exit0. The unchanged static scanner has no matches (git grep exit1, equivalent workflow success). No new full/live run. This documentation-only record follows the tested merge; exact replacement-head CI remains required.
