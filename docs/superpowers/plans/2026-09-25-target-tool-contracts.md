...
Committed reviewed fixture delta293edf7 then integrated snapshot main e173d432f767fe76e1c1f101d9cd8824ffee612d without conflicts. Post-integration tests/task_runtime/test_secure_snapshot_boundary.py, tests/agent/test_docking_tool_contract.py, test_target_tool_contract.py and test_tool_registry.py:486 passed3 POSIX-skipped4.46s, exit0. Target production and fixtures unchanged in this integration. Required exact-headCI8/8 pending.
